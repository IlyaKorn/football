...
export const useIndexStore = defineStore('index', {
  ...
  actions: {
    ...
    getCountries () {
      fetch('https://v3.football.api-sports.io/countries', {...fetchSettings})
    ...
    getLeaguesByCountry (country) {
      fetch(`https://v3.football.api-sports.io/leagues?country=${country}`, {...fetchSettings})
        .then(response => response.json())
    ...
    getTeamsByParams (leagueId, seasonId) {
      fetch(`https://v3.football.api-sports.io/teams?league=${leagueId}&season=${seasonId}`, {...fetchSettings})
        .then(response => response.json())
        .then(res => this.setTeams(res.response))
        .catch(err => {
          console.error(err);
        });
    },
