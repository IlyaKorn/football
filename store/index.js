  ...
  state: () => ({
    ...
    countries: [
      ...
      },
      {
        name: "Austria",
        code: "AT",
        flag: "https://media-3.api-sports.io/flags/at.svg"
      },
      {
        name: "Azerbaidjan",
        code: "AZ",
      ...
      },
      {
        name: "Chinese-Taipei",
        code: "TW",
        flag: "https://media-2.api-sports.io/flags/tw.svg"
      },
      {
        name: "Colombia",
        code: "CO",
      ...
      },
      {
        ...
        code: "DO",
        flag: "https://media-1.api-sports.io/flags/do.svg"
      },
      {
        name: "Ecuador",
        code: "EC",
      ...
      },
      {
        name: "Finland",
        code: "FI",
        flag: "https://media-2.api-sports.io/flags/fi.svg"
      },
      {
        name: "France",
        code: "FR",
      ...
      },
      {
        name: "Guadeloupe",
        code: "GP",
        flag: "https://media-1.api-sports.io/flags/gp.svg"
      },
      {
        name: "Guatemala",
        code: "GT",
      ...
      },
      {
        name: "Ireland",
        code: "IE",
        flag: "https://media-2.api-sports.io/flags/ie.svg"
      },
      {
        name: "Israel",
        code: "IL",
      ...
      },
      {
        name: "Kosovo",
        code: "XK",
        flag: "https://media-1.api-sports.io/flags/xk.svg"
      },
      {
        name: "Kuwait",
        code: "KW",
      ...
      },
      {
        name: "Mauritius",
        code: "MU",
        flag: "https://media-2.api-sports.io/flags/mu.svg"
      },
      {
        name: "Mexico",
        code: "MX",
      ...
      },
      {
        name: "Pakistan",
        code: "PK",
        flag: "https://media-2.api-sports.io/flags/pk.svg"
      },
      {
        name: "Palestine",
        code: "PS",
      ...
      },
      {
        name: "Syria",
        code: "SY",
        flag: "https://media-1.api-sports.io/flags/sy.svg"
      },
      {
        name: "Tajikistan",
        code: "TJ",
      ...
      },
      {
        name: "Turkmenistan",
        code: "TM",
        flag: "https://media-1.api-sports.io/flags/tm.svg"
      },
      {
        name: "Uganda",
        code: "UG",
      ...
      },
      {
        name: "Uruguay",
        code: "UY",
        flag: "https://media-2.api-sports.io/flags/uy.svg"
      },
      {
        name: "USA",
        code: "US",
  ...
  actions: {
    ...
    getCountries () {
      fetch("https://v3.football.api-sports.io/countries", {
        ...
        .then(res => this.countries = res.response)
        .catch(err => {
          console.error(err);
        });
    },
    ...
    getLeaguesByCountry (country) {
      // fetch(`https://v3.football.api-sports.io/leagues?country=${country}`, {
      //   'method': 'GET',
      //   'headers': {
      //     'x-rapidapi-host': 'v3.football.api-sports.io',
      //     'x-rapidapi-key': 'eea11af86c8f55004f6e8c8a77295fad'
      ...
      // })
      //   .then(response => response.json())
      //   .then(res => this.setLeagues(res.response))
      //   .catch(err => {
      //     console.error(err);
      //   });
      this.setLeagues([
        {
          "league": {
            ...
            "type": "League",
            "logo": "https://media-2.api-sports.io/football/leagues/513.png"
          },
          "country": {
            "name": "Albania",
            "code": "AL",
        ...
        },
        {
          "league": {
            ...
            "name": "Superliga",
            "type": "League",
            "logo": "https://media-1.api-sports.io/football/leagues/310.png"
          },
          "country": {
            "name": "Albania",
            "code": "AL",
        ...
        },
        {
          "league": {
            ...
            "name": "1st Division",
            "type": "League",
            "logo": "https://media-3.api-sports.io/football/leagues/311.png"
          },
          "country": {
            "name": "Albania",
            "code": "AL",
        ...
        },
        {
          "league": {
            ...
            "name": "Cup",
            "type": "Cup",
            "logo": "https://media-2.api-sports.io/football/leagues/707.png"
          },
          "country": {
            "name": "Albania",
            "code": "AL",
        ...
        },
        {
          "league": {
            ...
            "name": "Super Cup",
            "type": "Cup",
            "logo": "https://media-1.api-sports.io/football/leagues/708.png"
          },
          "country": {
            "name": "Albania",
            "code": "AL",
        ...
        },
        {
          "league": {
            ...
            "type": "League",
            "logo": "https://media-3.api-sports.io/football/leagues/978.png"
          },
          "country": {
            "name": "Albania",
            "code": "AL",
